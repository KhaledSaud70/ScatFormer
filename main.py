...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'ScatFormer training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=128, type=int) #128
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='scatformer_l1', type=str, metavar='MODEL',
    ...
    parser.add_argument('--overfit_batches', type=float, default=0.0,
                    help='Overfit a fraction of training/validation data. Default: 0.0.')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'scatformer training and evaluation script', parents=[get_args_parser()])
